...
class ColorsDark implements AppColors {
  ...
  @override
  Color get onSurface => Color(0xFF444444);

  @override
  Color get success => Color(0xFF1AD139);

  @override
  Color get surface => Color(0xFF444444);

  @override
  Color get textInput => Color(0xFFF0F0F0);

  @override
  Color get textInputLabel => Color(0xFFF0F0F0);

  @override
  Color get textPrimary => Color(0xFFFEFEFE);

  @override
  Color get textSecondary => Color(0xFFF0F0F0);
  ...
  @override
  Color get primary => Color(0xFF444444);
  ...
  @override
  Color get shadowColor => Color(0xFF444444);
