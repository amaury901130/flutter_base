...
abstract class LocalTheme {
  ...
  ColorScheme get colorScheme => ColorScheme(
        ...
        secondaryVariant: MaterialAccentColor(
  ...
  final primaryFont = '';
  final primaryFontBlack = '';
  final primaryFontMedium = '';
  final primaryFontRoman = '';
  final primaryFontHeavy = '';
